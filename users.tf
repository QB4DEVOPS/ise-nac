...
#
# CiscoDevNet/ise 0.4.1 resource is ise_internal_user (not ise_user).
...
# 0.4.1 sorts that list on read (ISE order varies); do not fight the sort.
# custom_attributes is a map of strings in 0.4.x (not jsonencode). Not set.
