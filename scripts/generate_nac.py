...
def main() -> int:
    ...
    # Lab 110 only. Never fold endpoints_enterprise.csv into this feed.
    ...
    lines: list[str] = [
        ...
        "# Lab endpoints.csv only (110). endpoints_enterprise.csv is Git inventory; not this feed. pan1 apply stays 110.",
